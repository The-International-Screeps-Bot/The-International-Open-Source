        ...
        console.log(`
            <table style="background: rgba(255, 255, 255, 0.1); padding: 6px; border-radius: 4px; width: 90vw; border-collapse: initial; box-shadow: rgba(0, 0, 0, 0.18) 0 12px 30px 0; overflow: hidden; font-family: 'Roboto', sans-serif; margin-left: 10px;">
                ...
                <tr style="background: rgba(44, 97, 242, 1);">
                    <th style="color: white; font-size: 15px; text-align: center; padding: 6px 0px; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Actions</th>
                ...
                <tr>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">New Commune (room name) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Attack (room name) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Attack (username) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Send Resources (room name, type, amount) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Add Ally (username) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                </tr>
                <tr>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Set Threat (room name) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                    <th style="text-align: center; padding: 5px 0; border-top-left-radius: 4px; border-bottom-left-radius: 4px;">Set threat (username) ` + `<input style="background: rgba(255, 255, 255, 0.15); padding: 5px; border: none; color: white; font-weight: 400; text-transform: uppercase;">` + `</th>
                </tr>
                <tr style="background: rgba(44, 97, 242, 1);">
