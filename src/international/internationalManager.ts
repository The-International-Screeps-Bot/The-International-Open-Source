...
export class InternationalManager {
    ...
    get myOrders() {
        ...
        for (const orderID in Game.market.orders) {
            ...
            this._myOrders[order.roomName][order.type][order.resourceType].push(
                order
            )
        }
...
InternationalManager.prototype.getSellOrders = function (
    resourceType,
    maxPrice
) {
...
InternationalManager.prototype.getBuyOrders = function (
    resourceType,
    minPrice
) {
