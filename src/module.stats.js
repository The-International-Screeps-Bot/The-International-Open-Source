module.exports = {
    run: function stats() {
        ...
        Memory.stats.creepsPerRoom = (Object.keys(Memory.creeps).length / Memory.global.communesCount).toFixed(2)
        ...
        Memory.stats.cpuPerCommune = (Memory.stats.cpuUsage / Memory.global.communesCount).toFixed(2)
    }
}