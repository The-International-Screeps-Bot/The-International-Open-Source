...
export class RoomTask {
    constructor(type: RoomTaskTypes, creatorID: Id<any>, roomName: string) {
        ...
        if (!global[creatorID].createdTaskIDs)
            global[creatorID].createdTaskIDs = {}
...
RoomTask.prototype.findLocation = function () {
    ...
    if (global[task.roomName].tasksWithResponders[task.ID])
        return global[task.roomName].tasksWithResponders
