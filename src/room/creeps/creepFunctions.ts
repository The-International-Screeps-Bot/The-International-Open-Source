...
Creep.prototype.recurseMoveRequest = function(packedPos) {
    ...
    if (!creepNameAtPos) {
        ...
        for (let index = creep.queue.length - 1; index > 0; index--) {
...
/*
            ...
            creepAtPos.queue.push(creep.name)
