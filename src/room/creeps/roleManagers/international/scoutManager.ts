...
export function scoutManager(room: Room, creepsOfRole: string[]) {
     ...
     for (const creepName of creepsOfRole) {
          ...
          // If there is a controller and it isn't in safeMode, sign the controller

          if (room.controller && !room.controller.safeMode) if (creep.advancedSignController()) continue
